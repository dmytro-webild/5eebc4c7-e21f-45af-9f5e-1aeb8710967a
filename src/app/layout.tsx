...
export const metadata: Metadata = {
  title: "ElectroServe - Electrician Profesional Local | Servicii 24/7",  description: "Electrician certificat cu 15+ ani experiență. Instalații, reparații urgente, servicii 24/7. Apelează pentru ofertă gratuită!",  keywords: "electrician local, servicii electrice, reparații urgente, instalații electrice, electrician 24/7",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "ElectroServe - Electrician Profesional Local",    description: "Servicii electrice profesionale de încredere pentru locuințe și întreprinderi. Disponibil 24/7.",    siteName: "ElectroServe",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/male-builder-electrical-engineer-overalls-helmet-holds-toolbox-hands-space-text_169016-66721.jpg",        alt: "Electrician profesional ElectroServe"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "ElectroServe - Electrician Profesional",    description: "Servicii electrice de calitate. Apelează acum!",    images: ["http://img.b2bpic.net/free-photo/male-builder-electrical-engineer-overalls-helmet-holds-toolbox-hands-space-text_169016-66721.jpg"],
  },
};
